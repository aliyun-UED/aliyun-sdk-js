...
ALY.OSS = ALY.Service.defineService('oss', ['2013-10-15'], {
  ...
  populateURI: function populateURI(req) {
    ...
    if (b) {
      // is IP
      if(ipv4Regex.test(httpRequest.endpoint.hostname) || ipv6Regex.test(httpRequest.endpoint.hostname)){
        httpRequest.endpoint.host = httpRequest.endpoint.hostname =  httpRequest.endpoint.hostname;
      }else{
