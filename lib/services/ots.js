...
ALY.OTS = ALY.Service.defineService('ots', ['2014-08-08'], {
  ...
  addContentType: function addContentType(req) {
    ...
    httpRequest.headers['x-ots-instancename'] = req.params.InstanceName;
  },

  buildContent: function buildContent(req) {
    var ListTableRequest = protos.ListTableRequest;

    r = new ListTableRequest({});

    var buffer = r.encode();

    req.httpRequest.body = buffer.buffer;
  },
  ...
  extractData: function extractData(resp) {
    console.log(protos.ListTableResponse.decode(resp.httpResponse.body));
  },
