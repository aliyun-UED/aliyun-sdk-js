...
ALY.util = {
  ...
  userAgent: function userAgent() {
    ...
    var agent = 'aliyun-sdk-' + name + '/' + ALY.VERSION;
    if (name === 'nodejs') agent += ' ' + ALY.util.engine();
    return agent;
  },
  ...
  uriEscape: function uriEscape(string) {
    ...
    // ALY percent-encodes some extra non-standard characters in a URI
  ...
  date: {
    ...
    topDateFormat: function formatDate(date) {
      var fmt = '%Y-%M-%d %H:%m:%s';
    ...
    format: function format(date, formatter) {
      if (!formatter) formatter = 'unixTimestamp';
